...
class ejercicio4(unittest.testCase):
    def test_is_vacio_seDeterminaCampeon(self):
        self.assertEquals(ejercicio4.is_calcularGanadorDeLiga([]))

    def test_is__a1_b0__seDeterminaCampeon(self):
        self.assertEquals(ejercicio4.is_calcularGanadorDeLiga([("a",1,"b",0)]))

    def test_is__a1_b1__a1_c1__c1_b1__seDeterminaCampeon(self):
        self.assertEquals(ejercicio4.is_calcularGanadorDeLiga([("a",1,"b",1),("a",1,"c",1),("c",1,"b",1)]))

    def test_is__a1_b0__a1_c2__c3_b0__seDeterminaCampeon(self):
        self.assertEquals(ejercicio4.is_calcularGanadorDeLiga([("a",1,"b",0),("a",1,"c",2),("c",3,"b",0)]))

    def test_is__a1_bmenos2__a1_c1__c1_b1__d1_a9__seDeterminaCampeon(self):
        self.assertEquals(ejercicio4.is_calcularGanadorDeLiga([("a",1,"b",-2),("a",1,"c",1),("c",1,"b",1),("d",1,"a",9)]))
